...
public class Lesson15 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 协程本体是一个能够中间暂停返回的函数
        // 协程调度器是Unity内部实现的,会在对应的时机帮我们 继续执行协程函数
        ...
        // 但是我们可以自己执行迭代器函数内容
        // ie.MoveNext(); // 执行函数中内容遇到 yield return为止的逻辑
        // print(ie.Current);
        // ie.MoveNext();
        // print(ie.Current);
        // ie.MoveNext();
        ...
        // 具体的 yield return 后面的规则 也是Unity定义的一些规则
        ...
        // 理论上来说 可以利用迭代器函数的特点 自己实现协程调度器来取代Unity自带的调度器
        #endregion
