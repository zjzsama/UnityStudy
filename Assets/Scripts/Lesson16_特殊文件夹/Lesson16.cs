...
public class Lesson16 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 作用
        // 资源文件夹:
        // 1-1.需要通过Resources相关API动态加载的资源放在其中
        // 1-2.该文件夹下所有文佳都会被打包出去
        // 1-3.打包时Unity会对其进行压缩加密
        ...
        // 作用:
        // 3-1.所有平台可读可写
        // 3-2.一般用于放置动态下载或者动态创建的文件,游戏中创建或者获取的文件夹都放在其中
        #endregion
